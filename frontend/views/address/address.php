	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="address_hd">
				...
				<dl id="qwer_<?=$row['id']?>">
					<dt><?=$row['name']?>&emsp;<?=$row['province']?>&emsp;<?=$row['city']?>&emsp;<?=$row['area']?>&emsp;<?=$row['address']?>&emsp;<?=$row['tel']?></dt>
					<dd>
			...
			<div class="address_bd mt10">
				<h4>新增收货地址</h4>
				<form action="<?=\yii\helpers\Url::to(['address/add'])?>" name="address_form" id="form" method="post">
                    <input type="hidden" id="eid" name="id" class="txt" value="<?=$model->id?>"/>
						<ul>
							<li>
							...
							<li>
								<label for="">&nbsp;</label>
								<input type="submit" name="" class="btn" value="保存" id="submit" />
							</li>
						</ul>
					</form>
			</div>	
        ...
        <script type="text/javascript">
            ...
            /*$("#submit").click(function(){
                ...
                $.post('', $('#form').serialize(),function(data){
                    ...
                    if($("#qwer_"+data.id)){
                        $("#qwer_"+data.id).remove();
                    }
                   // data = $.parseJSON(data);
                    //console.log(data);
                        html += '<dl id="qwer_'+data.id+'" class="last">';
                        html += '<dt>'+ data.name +'&emsp;'+ data.province +'&emsp;' +data.city +'&emsp;'+ data.area+'&emsp;' +data.address +'&emsp;'+data.tel+'</dt>';
                        html += '<dd>';
                        html += '<a href="">修改</a>';
                        html += '<a href="">删除</a>';
