	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到一木一草！[<a href="login.html">登录</a>] [<a href="register.html">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="login w990 bc mt10 regist">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="<?=\yii\helpers\Url::to(['site/register'])?>" method="post" id="signupForm">
					<ul>
						<li>
							<label for="">用户名：</label>
						...
						<li class="checkcode">
							...
							<img src="<?=\yii\helpers\Url::to(['site/captcha'])?>" alt="" id="img_captcha"/>
            ...
            $("#signupForm").validate({
                rules: {
                    username: {
                        ...
                        minlength: 2,
                        remote: {
                            url: "<?=\yii\helpers\Url::to(['site/check-user'])?>",     //后台处理程序
                        }
                    },
                    password: {
                        required: true,
                ...
                captcha:{
                    required: true,
                    remote: {
                        url: "<?=\yii\helpers\Url::to(['site/check-captcha'])?>",     //后台处理程序
                        type: "get",               //数据发送方式
