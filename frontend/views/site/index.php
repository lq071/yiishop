...
<!--			<div class="search fl">
		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<!--<div class="cat_bd">
                    <?php /*foreach ($rows as $k1=>$row):*/?>
					<div class="cat <?/*=$k1 ? '': 'item1'*/?>">

						<h3><a href="<?/*=\yii\helpers\Url::to(['site/list','id'=>$row->id])*/?>"><?/*=$row->name*/?></a> <b></b></h3>
						<div class="cat_detail">

                            <?php /*foreach ($row ->subCategory as $k2=>$item):*/?>
							<dl class="<?/*=$k2 ? '': 'dl_1st'*/?>">
								<dt><a href="<?/*=\yii\helpers\Url::to(['site/list','id'=>$item->id])*/?>"><?/*=$item->name*/?></a></dt>
								<dd>
                                    <?php /*foreach ($item ->subCategory as $e):*/?>
									<a href="<?/*=\yii\helpers\Url::to(['site/list','id'=>$e->id])*/?>"><?/*=$e->name*/?></a>
                                    <?php /*endforeach; */?>
								</dd>
							</dl>
                            <?php /*endforeach; */?>
