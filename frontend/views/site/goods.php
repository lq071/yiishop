...
?>
	...
	<div class="header w1210 bc mt15">
		<!-- 头部上半部分 start 包括 logo、搜索、用户中心和购物车结算 -->
             ...
             * @var $this \yii\web\View
             */
            echo $this->render('@webroot/public/center');
            ?>
			<!-- 购物车 start -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$row->gallery[0]->path?>" style="width: 800px" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$row->gallery[0]->path?>" width="350px" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <li class="cur">
                                    <a class="zoomThumbActive" href="<?=$row->gallery[0]->path?>" rel="{gallery: 'gal1', smallimage: '<?=$row->gallery[0]->path?>',largeimage: '<?=$row->gallery[0]->path?>'}" style="width: 54px"><img src="<?=$row->gallery[0]->path?>"></a>
                                </li>
                                <?php foreach ($row->gallery as $gallery):?>
                                    <li>
                                        <a  href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$gallery->path?>',largeimage: '<?=$gallery->path?>'}" ><img src="<?=$gallery->path?>" width="350px"></a>
                                    </li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=$row->view_times?>人浏览)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
